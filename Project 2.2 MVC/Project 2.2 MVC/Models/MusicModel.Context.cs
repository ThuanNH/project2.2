...
namespace Project_2._2_MVC.Models
{
    ...
    public partial class MusicWeb_DBEntities : DbContext
    {
        ...
        public DbSet<userreportAccount> userreportAccount { get; set; }
        public DbSet<userreportSong> userreportSong { get; set; }
        public DbSet<userreportVideo> userreportVideo { get; set; }
